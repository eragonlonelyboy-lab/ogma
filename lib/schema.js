...
function validateCertificate(c, errors) {
  ...
  if (!isNonEmptyString(c.generated_at, 40) || !ISO_INSTANT.test(c.generated_at)) {
...
function validatePushState(p, errors) {
  ...
  if (!isNonEmptyString(p.delivered_at, 40) || !ISO_INSTANT.test(p.delivered_at)) {
