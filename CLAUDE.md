...
lib/gate.js        The Gate — ten checks + certificate emission (leaklint, readability, coverage, binding, annotation resolution, freshness incl. render byte-binding)
lib/util.js        Shared plumbing — readJson, nowIso, refuseSymlink, the symlink-guarded ogmaWrite every write site uses, escapeXml
